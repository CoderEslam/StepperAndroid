...
import com.doubleclick.stepperandroid.databinding.TabStepperWithOverflowActivityBinding
...
class TabStepperWithOverflowActivity : AppCompatActivity(), StepperNavListener {
    ...
    private lateinit var binding: TabStepperWithOverflowActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TabStepperWithOverflowActivityBinding.inflate(layoutInflater)
